document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if ((name.toLowerCase().includes('name')) && value !== '' && value.length < 2) {
  ...
  const ANIMATION_SELECTORS = '.animate-on-scroll, .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .blog-card, .gallery-item, .stat-item, .step-item';
  ...
  if (animatableElements.length > 0) {
    animatableElements.forEach(function (el, index) {
      ...
      const delay = el.dataset.delay || (index % 4) * 100;
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "ZFTech - Zohar Frenkel uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '84989a11-7670-47b5-be7c-50d99d180c2a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '84989a11-7670-47b5-be7c-50d99d180c2a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '84989a11-7670-47b5-be7c-50d99d180c2a';
